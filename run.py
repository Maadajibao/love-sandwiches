...
def  get_sales_data():
    ...
    while True:
            ...
            print("Data should be six numbers, separated by comma.s")
...
def calculate_surplus_data(sales_row):
    ...
    - Positive spurplus indicates waste
...
def update_surplus_worksheet(new_surplus_data):
    """
    Updates surplus worksheet, add new row with the surplus data
    """

    print("Updating surplus worksheet...\n")

    surplus_sheet = SHEET.worksheet("surplus")
    surplus_sheet.append_row(new_surplus_data)
